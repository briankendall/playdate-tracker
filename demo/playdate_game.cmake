...
if (TOOLCHAIN STREQUAL "armgcc")
	...
	set_property(
		TARGET ${PLAYDATE_GAME_DEVICE} APPEND PROPERTY ADDITIONAL_CLEAN_FILES
		${PLAYDATE_PDX_DIR}/${PLAYDATE_GAME_NAME}.pdx
		)

	add_custom_command(
		TARGET ${PLAYDATE_GAME_DEVICE} POST_BUILD
		COMMAND ${PDC} Source ${PLAYDATE_PDX_DIR}/${PLAYDATE_GAME_NAME}.pdx
	...
	if (MSVC)
		...
		if(${CMAKE_GENERATOR} MATCHES "Visual Studio*" )
			...
			file(TO_NATIVE_PATH ${PLAYDATE_PDX_DIR}/${PLAYDATE_GAME_NAME}.pdx SIMGAMEPATH)
	...
	elseif(APPLE)
		...
		if(${CMAKE_GENERATOR} MATCHES "Xcode" )
			set(BUILD_SUB_DIR $<CONFIG>/)
			set_property(TARGET ${PLAYDATE_GAME_NAME} PROPERTY XCODE_SCHEME_ARGUMENTS \"${PLAYDATE_PDX_DIR}/${PLAYDATE_GAME_NAME}.pdx\")
